...
const frameProps = {   lines: [{ title: "TPS Report", coordinates: [
  ...
  axes: [{ orient: "left", label: "Win Probability in %", tickFormat: function(e){return e} },
    { orient: "bottom", label: { name: "Number of Days", locationDistance: 55 } }],
